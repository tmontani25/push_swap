...
#    Updated: 2024/04/02 17:09:17 by tmontani         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PUSH_SWAP = push_swap.c stack_utils.c rotate.c reverse_rotate.c swap.c push.c send_to_algo.c stack_utils2.c sort_3.c big_sort.c push_cost.c stack_elements.c
